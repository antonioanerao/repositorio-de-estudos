...
@section('content')
    ...
    <div class="relative overflow-hidden">
        <div class="relative max-w-screen-xl mx-auto px-5 pt-16 md:pt-32 space-y-8 md:space-y-0 md:flex md:items-end">
            <div class="md:flex-1">
                <h1 class="max-w-md font-medium text-3xl tracking-tight sm:text-4xl md:max-w-4xl md:text-5xl md:leading-tight xl:text-6xl">Time de Desenvolvedores</h1>
                <p class="mt-3 max-w-xl text-gray-600 sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam at autem consectetur ea, eos eum eveniet, excepturi ipsa minus nemo obcaecati odio quisquam ratione sapiente tenetur vero vitae. Officia, recusandae!</p>
            </div>
        </div>
